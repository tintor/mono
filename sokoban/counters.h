...
struct Counters {
    ...
    void print() const {
        ...
        ::print(", db_contains_pattern {:.1f}, contains_frozen_boxes {:.1f} {:.1f}",
            Sec(db_contains_pattern_ticks), Sec(contains_frozen_boxes_ticks), Rel(contains_frozen_boxes_ticks));
        ...
        ::print("deadlocks (simple {}, db {}, frozen_box {}, heuristic {})", simple_deadlocks, db_deadlocks, frozen_box_deadlocks, heuristic_deadlocks);
